...
public class StandardizedProjectile : MonoBehaviour
{
    ...
    public string stoneDetectionTagToHash = "Stone";
         ...
         [Tooltip("Tag names of the objects that needs to be registered as stone.")]
         public string playerDetectionTagToHash = "Player";
    ...
    private static int fleshHash, woodHash, stoneHash, metalHash, contactHash, projectileHash, playerHash;
    ...
    {        
        ...
        playerHash = playerDetectionTagToHash.GetHashCode();
...

    {
        ...
        else if (contactHash == playerHash)
        {
            // Contact with player           
