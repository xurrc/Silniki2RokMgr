...
public class StandardizedBow : MonoBehaviour
{
    ...
    void update()
    {
               ...
               //lastProjectile. = lastProjectileTransform.localPosition + bowStringPoint.localPosition;
           
               //pozycjastrzaly = lastProjectileTransform.localPosition;
               //transform.position = pozycjastrzaly;
